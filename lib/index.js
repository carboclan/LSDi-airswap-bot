      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return _context.abrupt("return", (0, _bignumber["default"])(value).multiplyBy(100).dp(2));
          ...
          case 8:
                  ...
                  while (1) {
                    switch (_context4.prev = _context4.next) {
                      ...
                      case 17:
                        ...
                        requiredMakerAmount = eighteenToFive(requestedAmount.dividedBy(price)).decimal(0);
                  ...
                  while (1) {
                    switch (_context5.prev = _context5.next) {
                      ...
                      case 8:
                        ...
                        makerAmount = eighteenToFive(requiredMakerAmount).decimalPlaces(0).toString();
                        result = {
                          makerAddress: makerAddress,
                          makerAmount: makerAmount,
                          makerToken: makerToken,
            ...
            function () {
              ...
              regeneratorRuntime.mark(function _callee6(payload) {
                var message, sender, id, makerAddress, makerToken, takerToken, makerBalance, price, makerAmount, takerAmount, result, response;
                  ...
                  while (1) {
                    switch (_context6.prev = _context6.next) {
                      ...
                      case 8:
                        ...
                        takerAmount = makerBalance.multipliedBy(price).decimal(0).toString() + thirteen;
                        result = {
                          makerAddress: makerAddress,
                          makerAmount: makerAmount,
                          makerToken: makerToken,
