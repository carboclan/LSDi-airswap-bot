      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            value = feed.cToken[0].supply_rate.value; // TODO: Any math here... rounding!!

            return _context.abrupt("return", (0, _bignumber["default"])(value).multipliedBy(100).dp(2));
          ...
          case 8:
            ...
            function () {
              ...
              regeneratorRuntime.mark(function _callee4(payload) {
                var message, sender, _message$params, id, makerToken, takerAddress, takerToken, takerAmount, makerAddress, takerBalance, makerBalance, price, requestedAmount, requiredMakerAmount, expiration, makerAmount, nonce, order, result, response;
                  ...
                  while (1) {
                    switch (_context4.prev = _context4.next) {
                      case 0:
                        ...
                        _message$params = message.params, id = _message$params.id, makerToken = _message$params.makerToken, takerAddress = _message$params.takerAddress, takerToken = _message$params.takerToken, takerAmount = _message$params.takerAmount;
                        makerAddress = address; // get their token balance
                      ...
                      case 15:
                        ...
                        requestedAmount = (0, _bignumber["default"])(takerAmount);
                        requiredMakerAmount = eighteenToFive(requestedAmount.dividedBy(price)).dp(0);
                      ...
                      case 21:
                        ...
                        makerAmount = requiredMakerAmount.toString();
            ...
            function () {
              ...
              regeneratorRuntime.mark(function _callee5(payload) {
                var message, sender, _message$params2, id, makerAddress, makerToken, takerAmount, takerToken, price, requestedAmount, requiredMakerAmount, makerAmount, result, response;
                  ...
                  while (1) {
                    switch (_context5.prev = _context5.next) {
                      case 0:
                        ...
                        message = payload.message, sender = payload.sender;
                        _message$params2 = message.params, id = _message$params2.id, makerAddress = _message$params2.makerAddress, makerToken = _message$params2.makerToken, takerAmount = _message$params2.takerAmount, takerToken = _message$params2.takerToken;
                        _context5.next = 5;
                        return getPrice();
            ...
            function () {
              ...
              regeneratorRuntime.mark(function _callee6(payload) {
                var message, sender, _message$params3, id, makerAddress, makerToken, takerToken, makerBalance, price, makerAmount, takerAmount, result, response;
                  ...
                  while (1) {
                    switch (_context6.prev = _context6.next) {
                      case 0:
                        ...
                        message = payload.message, sender = payload.sender;
                        _message$params3 = message.params, id = _message$params3.id, makerAddress = _message$params3.makerAddress, makerToken = _message$params3.makerToken, takerToken = _message$params3.takerToken; // get our token balance
